...
- Now go to cloned directory and run `fishing.sh` -
  ```
  $ cd phisher
  $ bash fishing.sh
  ```
...
- Download `.deb` files from the [**Latest Release**](https://github.com/sevenhzl/phizer.git
...
- By using the wrapper script [**run-docker.sh**](https://raw.github.com/sevenhzl/phizer/run-docker.sh)

  ```
  $ curl -LO https://raw.github.com/sevenhzl/phizer/run-docker.sh
  $ bash run-docker.sh
  ```
- Temporary Container

  ```
  docker run --rm -ti sevenhzl/phisher
  ```
