...
- Just, Clone this repository -
  ```
  git clone --depth=1 https://github.com/sevenhzl/phizer.git
  ```
...
<p align="left">
  <a href="https://shell.cloud.google.com/cloudshell/open?cloudshell_git_repo=https://github.com/sevenhzl/phizer.git&tutorial=README.md" target="_blank"><img src="https://gstatic.com/cloudssh/images/open-btn.svg"></a>
</p>
...
- Download `.deb` files from the [**Latest Release**](https://github.com/sevenhzl/phizer/releases/latest)
...
- By using the wrapper script [**run-docker.sh**](https://raw.githubusercontent.com/hzlsvn/phisher/master/run-docker.sh)

  ```
  $ curl -LO https://raw.githubusercontent.com/hzlsvn/phisher/master/run-docker.sh
  $ bash run-docker.sh
  ```
- Temporary Container
